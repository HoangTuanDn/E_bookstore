    ...
    <div class="card">
        <div class="card-header d-flex flex-row align-content-center flex-wrap">
            ...
            <div class="dropdown flex-grow-1">
                <button class="btn btn-outline-success btn-sm dropdown-toggle m-1" type="button" id="dropdownMenu2"
                ...
                @can('setting-create')
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                        ...
                        <a href="{{route('settings.create', ['type' => 'textarea'])}}" class="dropdown-item">Text
                            area</a>
                    </div>
                @endcan
            </div>
                            ...
                            <td class="project-actions text-center">
                                @can('setting-update')
                                    <a class="btn btn-outline-info btn-sm m-1"
                                       href="{{route('settings.edit', ['id' => $setting->id])}}">
