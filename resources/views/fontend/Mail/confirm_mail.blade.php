            ...
            @if($data['payment_id'] === 3)
                <div class="row">
                    <div class="content col-md-12 col-sm-12 ol-lg-12">
                        ...
                        <p>
                            Đơn hàng của bạn đã được xác nhận. Chúng tôi sẽ cố gắng chuyển hàng đến cho bạn trong thời gian sớm nhất, hay vào mục đơn hàng của tôi để kiểm tra tiến độ đơn hàng, xin chân thành cảm ơn.
                        </p>
            ...
            @else
                <div class="row">
                    <div class="content col-md-12 col-sm-12 ol-lg-12">
                        ...
                        <p>xin chào {{$data['full_name']}}.</p>
                        <p>
                            Đơn hàng của bạn đã được xác nhận, đơn hàng sẽ được giữ
