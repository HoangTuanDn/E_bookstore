...
@section('content')
    ...
    <div class="ht__bradcaump__area bg-image--4">
        @include('fontend.breadcumb',['pageNameLC' => __('check_out')])
    </div>
    <!-- End Bradcaump area -->
    <!-- Start Checkout Area -->
                        ...
                        @if(auth()->guard('customer')->guest())
                            ...
                            <div class="checkout_login">
                                <form class="wn__checkout__form"
                                      action="{{route('account.login', ['language' => app()->getLocale()])}}">
                        ...
                        <div class="checkout_coupon">
                            <form action="{{route('home.checkout', ['language' => app()->getLocale()])}}">
                                <div class="form__coupon">
                                    <input type="text" name="coupon_code" value="{{$order['coupon_code'] ?? ''}}"
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="customer_details">
                        ...
                        <div class="customar__field" data-action="store-data"
                             data-url="{{route('home.checkout', ['language' => app()->getLocale()])}}">
                            <div class="margin_between">
                                <div class="input_box space_between" style="width: 100%">
                                    ...
                                    <input name="full_name" required type="text"
                                           value="{{isset(auth()->guard('customer')->user()->full_name) ? auth()->guard('customer')->user()->full_name : null}}">
                                </div>
                            </div>
                            <div class="input_box">
                                <label>{{__('province')}}<span>*</span></label>
                                <select required id="province" name="province_id" data-type="province"
                                        data-action="select-address" class="select__option">
                            ...
                            <div class="input_box">
                                ...
                                <select required id="district" name="district_id" data-type="district"
                                        data-action="select-address" class="select__option">
                            ...
                            <div class="input_box">
                                ...
                                <select required id="ward" name="ward_id" data-type="ward" data-action="select-address"
                            ...
                            <div class="input_box">
                                ...
                                <input required name="address"
                                       value="{{isset(auth()->guard('customer')->user()->address)? auth()->guard('customer')->user()->address : null}}"
                                       type="text" placeholder="{{__('placeholder_address')}}">
                            </div>
                            ...
                            <div class="margin_between">
                                <div class="input_box space_between">
                                    ...
                                    <input name="phone" required type="text"
                                           value="{{isset(auth()->guard('customer')->user()->phone) ? auth()->guard('customer')->user()->phone : null}}">
                                </div>

                                <div class="input_box space_between">
                                    <label>{{__('email')}} <span>*</span></label>
                                    <input name="email" required type="email"
                                           value="{{isset(auth()->guard('customer')->user()->email) ? auth()->guard('customer')->user()->email : null}}">
                                </div>
                            </div>
                            @if(!auth()->guard('customer')->guest())
                                <div class="create__account">
                                    <div class="wn__accountbox">
                                        <input class="input-checkbox" name="createaccount" value="1" type="checkbox"
                                               ...
                                               data-url="{{route('account.update', ['language' => app()->getLocale()])}}">
                                        <span>{{__('update_an_account')}}</span>
                                    </div>
                                </div>
                            @endif
                        </div>
                        <div class="order__form mt--20">
                            <form action="">
                                <div class="form__btn">
                                    <button data-url="{{isset($slug) ? route('home.order', ['language' => app()->getLocale(), 'slug' => $slug]) : route('home.order', ['language' => app()->getLocale()])}}"
                                            data-action="apply-order">{{__('apply_order')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="accordion" class="checkout_accordion mt--30" role="tablist">
                        <div class="payment">
                            ...
                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne"
                                ...
                                <div class="payment-apply">
                                    ...
                                    <input id="direct_bank_transfer" name="payment" data-index="0" value="1"
                                           type="radio">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="payment">
                            ...
                            <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree"
                                ...
                                <div class="payment-apply">
                                    <label for="">{{__('select_payment')}}</label>
                                    <input id="direct_bank_transfer" name="payment" data-index="0" value="2"
                                           type="radio">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="che__header" role="tab" id="headingFour">
                                <a class="collapsed checkout__title" data-toggle="collapse" href="#collapseFour"
                                   aria-expanded="false" aria-controls="collapseFour">
                                    <span>{{__('paypal')}} <img src="{{asset('fontend/images/icons/payment.png')}}"
                                    ...
                                    <div class="paypal_order__form">
                                        <form action="">
                                            <div class="form__btn_paypal">
                                                <button data-url="{{isset($slug) ? route('home.payment', ['language' => app()->getLocale(), 'slug' => $slug]) : route('home.payment', ['language' => app()->getLocale()])}}"
                                                        data-action="payment-checkout"><img
